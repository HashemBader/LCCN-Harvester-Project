...
class DashboardTabV2(QWidget):
    ...
    def refresh_data(self):
        ...
        try:
            ...
            # Invalid logic would ideally be tracked separately, here using placeholder or failed
            self.card_invalid.set_data(0, "Invalid ISBNs") 
    ...
    def update_live_status(self, target, isbn, progress, msg):
        ...
        self.lbl_run_status.setStyleSheet("color: #1e2030; font-weight: bold; padding: 5px 10px; background: #8aadf4; border-radius: 6px;")
