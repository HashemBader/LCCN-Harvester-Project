...
from .harvest_tab import HarvestWorker  # Reuse the worker from V1
...
class HarvestTabV2(QWidget):
    ...
    def set_input_file(self, path):
        ...
        try:
            ...
            if valid_count == 0:
                 self._set_invalid_state(path_obj.name, "File contains no valid ISBNs")
                 return
    ...
    def _start_worker(self, config, targets):
        ...
        self.worker = HarvestWorker(self.input_file, config, targets)
